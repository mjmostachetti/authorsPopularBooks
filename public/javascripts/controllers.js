  ...
  function($scope, $http){
    ...
    $scope.search = function(){
      ...
      .success(function(data){
        ...
        x.domain(tenBooks.map(function(d) { return d.title[0]; }));
        y.domain([0, d3.max(tenBooks, function(d) { return d.average_rating[0]; })]);

        svg.append("text")
            .attr("class", "title")
            .attr("x", x(tenBooks[0].title[0]))
            .attr("y", -26)
        ...
        svg.selectAll(".bar")
          ...
          .enter().append("rect")
            ...
            .attr("height", function(d) { return height - y(d.average_rating[0]); });
